...
<div class="form-group row ">
  {!! Form::label('limit_peer_user', "Limite por Usuário", ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
      {!! Form::number('limit_peer_user', null,  ['class' => 'form-control','autocomplete'=>'off','placeholder'=>  "Quantidade Máxima de Vezes que o mesmo usuário pode usar o cupom"  ]) !!}
    <div class="form-text text-muted">
      {{ "Quantidade Máxima de Vezes que o mesmo usuário pode usar o cupom" }}
    </div>
  </div>
</div>
