    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{!! url('settings/payment/stripe') !!}"><i class="fa fa-envelope-o mr-2"></i>{{trans('lang.app_setting_stripe')}}@if(setting('enable_stripe',false))<span class="badge ml-2 badge-success">{{trans('lang.active')}}</span>@endif
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{!! url('settings/payment/pagarme') !!}"><i class="fa fa-envelope-o mr-2"></i>{{"Pagar.me"}}@if(setting('enable_pagarme',false))<span class="badge ml-2 badge-success">{{trans('lang.active')}}</span>@endif
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="row">
                ...
                <!-- 'Boolean enable_facebook Field' -->
                    <div class="form-group row col-12">
                        {!! Form::label('enable_stripe', trans('lang.app_setting_enable_stripe'),['class' => 'col-3 control-label text-right']) !!}
                    ...
                    <div class="form-group row col-12">
                        {!! Form::label('stripe_key', trans('lang.app_setting_stripe_key'), ['class' => 'col-3 control-label text-right']) !!}
                        <div class="col-9">
                    ...
                    <div class="form-group row col-12">
                        {!! Form::label('stripe_secret', trans('lang.app_setting_stripe_secret'), ['class' => 'col-3 control-label text-right']) !!}
                        <div class="col-9">
