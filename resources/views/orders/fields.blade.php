...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::select('status',
            [
            'Aguardando o Cliente' => trans('lang.order_pending'),
            'Não foi Pago' => trans('lang.order_not_paid'),
            'Pago' => trans('lang.order_paid'),
            ]
    ...
    <!-- Hint Field -->
    <div class="form-group row ">
        {!! Form::label('observacao', "Observação do Cliente", ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::textarea('observacao', null, ['class' => 'form-control','placeholder'=>
             "Observação do Cliente"  ]) !!}
            <div class="form-text text-muted">Observação do Cliente</div>
        </div>
    </div>
    <!-- Hint Field -->
    <div class="form-group row ">
        {!! Form::label('troco_para', "Troco Para", ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            <input type="text" name="troco_para" value="{{$order->troco_para??''}}" class="form-control" placeholder="Troco">
            
            <div class="form-text text-muted">Dados de Troco</div>
        </div>
    </div>
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- Hint Field -->
    <div class="form-group row ">
        {!! Form::label('hint', "Dica Interna", ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
