...
@endcan
@if(exibeConfiguracoesPerigosas()) 
    @can('favorites.index')
        <li class="nav-item">
...
@can('drivers.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('drivers*') ? 'active' : '' }}" href="{!! route('drivers.index') !!}">@if($icons)<i class="nav-icon fa fa-motorcycle"></i>@endif<p>{{trans('lang.driver_plural')}} </p></a>
    </li>
@endcan
...
@can('cidades.index')
<li class="nav-item">
    <a class="nav-link {{ Request::is('cidades*') ? 'active' : '' }}" href="{!! route('cidades.index') !!}">@if($icons)<i class="nav-icon fa fa-map"></i>@endif<p>Cidades</p></a>
</li>
@endcan
