...
Route::get('public/storage/app/public/{id}/{conversion}/{filename?}', 'UploadController@storage');
Route::get('storage/app/public/{id}/{conversion}/{filename?}', 'UploadController@storage');


//Route::get('ajaxAlteraEstadoEstabelecimento', 'DashboardController@ajaxAlteraEstadoEstabelecimento')->name('ajaxAlteraEstadoEstabelecimento');
...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('cidades', 'CidadesController')->except([
        'show'
    ]);

    Route::post('market/buscaBairros','MarketController@buscaBairros')->name('market.buscaBairros');
