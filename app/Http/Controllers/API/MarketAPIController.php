...
class MarketAPIController extends Controller
{
    ...
    public function show(Request $request, $id)
    {
        ...
        $array = $market->toArray();

        /*
        Busca os bairros do estabelecimento
        */
        ...
        if(empty($market->bairros_json)){
            $array['possui_bairros_personalizados'] = false;
        }else{
            $bairrosJson = json_decode($market->bairros_json,true);
            $array['possui_bairros_personalizados'] = true;
            ...
            $array['bairros'] = $retornoArray;

        }

        return $this->sendResponse($array, 'Market retrieved successfully');
    }
